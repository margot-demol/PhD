...
download_dir = '/home/datawork-lops-osi/aponte/cswot/drifters/downloads'
raw_dir = '/home/datawork-lops-osi/aponte/cswot/drifters/raw'
root_dir = '/home1/datahome/mdemol/PhD/insitu_drifters_trajectories'
images_dir = '/home1/datahome/mdemol/PhD/insitu_drifters_trajectories/images'
...
def random_time_sampling(ds,t,dt, inplace=False):
    ...
    if not inplace : 
        return ds_off
"""
def random_time_sampling(ds,t,dt=1/24,offset_type='uniform', file=None, inplace=False):
